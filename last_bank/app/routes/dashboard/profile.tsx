  ...
  switch (action) {
    case 'save':
      ...
      if (Object.values(errors).some(Boolean))
        return json({ errors, fields: { occupation, firstName, lastName } }, { status: 400 })
...
export default function ProfileSettings () {
  ...
  const [formData, setFormData] = useState({
    ...
    currentLocation: actionData?.fields?.currentLocation || user?.profile?.currentLocation,
    pronouns: actionData?.fields?.pronouns || (user?.profile?.pronouns || 'MARKETING'),
